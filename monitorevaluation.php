...
$displayhtml .= '<p class="oremainheader">Monitoring/Evaluation</p>';
$displayhtml .= '</div>';
...
$displayhtml .= '<input id="monitorevaluation_personnel" list="monitorevaluationpersonnelnames" class="" onchange="checkmonitorpersonnel(this)" placeholder="Personnel" type="text">';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="stcs1a">';
$displayhtml .= '<div class="inputcontainerln icsnf">';
$displayhtml .= '<p class="normaltext">Entry Date</p>';
$displayhtml .= '<input id="monitorevaluation_entrydate" type="date">';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="inputcontainerln icsnf">';
$displayhtml .= '<p class="normaltext">Title</p>';
$displayhtml .= '<input id="monitorevaluation_title" type="text">';
$displayhtml .= '</div>';
$displayhtml .= '<div class="stcnsection1">';
$displayhtml .= '<div class="stcs1a">';
$displayhtml .= '<div class="inputcontainerln icsnf hidden">';
$displayhtml .= '<p class="normaltext">Start Date</p>';
$displayhtml .= '<input id="monitorevaluation_startdate" type="date">';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="stcs1a">';
$displayhtml .= '<div class="inputcontainerln icsnf hidden">';
$displayhtml .= '<p class="normaltext">End Date</p>';
$displayhtml .= '<input id="monitorevaluation_enddate" type="date">'; 
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="jformgroup">';
$displayhtml .= '<div id="monitorevaluationpreview">'; 
$displayhtml .= '</div>'; 
$displayhtml .= '<div class="jformgroup jformgroupcol file-action" style="display: block;">'; 
$displayhtml .= '<input id="monitorevaluation_file" onchange="monitorevaluationloadimg(this)" type="file" accept=".png, .jpeg, .jpg, .pdf, .docx" class="jformcontrol jmargin-top hidden" >';
...
$displayhtml .= '</div>';
$displayhtml .= '<div id="monitorevaluation_fileholder" class="fileholder"> 
                </div>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="oresubmitcontainer">';
$displayhtml .= '<div id="monitorevaluation_submitbtn" class="orerbtn">Submit</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div>';
$displayhtml .= '<div class="jtable-content">
                    <table class="jmargin-top" id="monitorevaluationpersonneltable">
                        <thead>
                            <tr>
                                <th>s/n </th>
                                <th> personnel </th>
                        ...
                        <tbody id="monitorevaluationpersonneltablecontent">
...
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<datalist id="monitorevaluationpersonnelnames"></datalist>';
echo $displayhtml;
?>