...
<div class="jcontainer">
    <h1 class="jpageheader"> REVERSED WITHDRAWALS  </h1>
    <div class="jpagecontent" id="jpagecontent">
        <form class="jform no-pr" id="filterviewreversedWithdrawalsform">
        ...
        <div id="jtabledata1"></div>
            <table class="jmargin-top" id="viewreversedWithdrawalstable">
                <thead>
                    <tr>
                        <th>s/n </th>
                        <th>T. date</th>
                        ...
                        <th> Voucher image </th>
                        <th> reference ID </th>
                        <th id="pitem" style="display:none">Property Items</th>
                        <th> account officer </th>
                        <th> debit </th>
                        <th class="tdetails hidden"> t. details </th>
                        <th class="no-pr" style="display:none"> Action </th>
                    </tr>
                </thead>
