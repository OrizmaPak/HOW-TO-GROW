...
$displayhtml .= '<p class="oremainheader">SUSPENSION</p>';
$displayhtml .= '</div>';
...
$displayhtml .= '<input id="suspension_personnel" list="suspensionpersonnelnames" class="" onchange="checksuspersonnel(this)" placeholder="Personnel" type="text">';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="stcs1a">';
$displayhtml .= '<div class="inputcontainerln icsnf">';
$displayhtml .= '<p class="normaltext">Entry Date</p>';
$displayhtml .= '<input id="suspension_entrydate" type="date">';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="inputcontainerln icsnf">';
$displayhtml .= '<p class="normaltext">Title</p>';
$displayhtml .= '<input id="suspension_title" type="text">';
$displayhtml .= '</div>';
$displayhtml .= '<div class="stcnsection1">';
$displayhtml .= '<div class="stcs1a">';
$displayhtml .= '<div class="inputcontainerln icsnf hidden">';
$displayhtml .= '<p class="normaltext">Start Date</p>';
$displayhtml .= '<input id="suspension_startdate" type="date">';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="stcs1a">';
$displayhtml .= '<div class="inputcontainerln icsnf hidden">';
$displayhtml .= '<p class="normaltext">End Date</p>';
$displayhtml .= '<input id="suspension_enddate" type="date">'; 
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="jformgroup">';
$displayhtml .= '<div id="suspensionpreview">'; 
$displayhtml .= '</div>'; 
$displayhtml .= '<div class="jformgroup jformgroupcol file-action" style="display: block;">'; 
$displayhtml .= '<input id="suspension_file" onchange="suspensionloadimg(this)" type="file" accept=".png, .jpeg, .jpg, .pdf, .docx" class="jformcontrol jmargin-top hidden" >';
...
$displayhtml .= '</div>';
$displayhtml .= '<div id="suspension_fileholder" class="fileholder"> 
                </div>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="oresubmitcontainer">';
$displayhtml .= '<div id="suspension_submitbtn" class="orerbtn">Submit</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div>';
$displayhtml .= '<div class="jtable-content">
                    <table class="jmargin-top" id="suspensionpersonneltable">
                        <thead>
                            <tr>
                                <th>s/n </th>
                                <th> personnel </th>
                        ...
                        <tbody id="suspensionpersonneltablecontent">
...
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<datalist id="suspensionpersonnelnames"></datalist>';
echo $displayhtml;
?>