...
<div class="jcontainer">
    <h1 class="jpageheader"> view reserved property stock </h1>
    <div class="jpagecontent">
        <form class="jform" id="viewreservedpropertystockform">
         ...
         <div class="jtable-content">
            <table class="jmargin-top" id="">
                ...
                <tbody id="viewreservedpropertystocktabledata"></tbody>
            </table>
        </div>
