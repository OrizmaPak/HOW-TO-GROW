...
$displayhtml .= '<p class="oremainheader">Payroll Class A</p>';
$displayhtml .= '</div>';
$displayhtml .= '';
...
$displayhtml .= '<select id="payrollclassamonth">';
...
$displayhtml .= '<select id="payrollclassayear">';
...
$displayhtml .= '<div id="payrollclassa_submitbtn" class="orerbtn">Fetch</div>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
...
$displayhtml .= '';
$displayhtml .= '<div id="payrollclassacontainer" class="jmargin-top"><div class="jflex jcontent-between no-pr jmargin-top" style="margin-bottom: 20px">
...
$displayhtml .= '<table class="jmargin-top" id="payrollclassatable">';
$displayhtml .= '<thead>';
$displayhtml .= '<tr>';
...
$displayhtml .= '<th> salary </th>';
$displayhtml .= '<th> total deduction </th>';
$displayhtml .= '<th> net payable </th>';
$displayhtml .= '</tr>';
$displayhtml .= '</thead>';
$displayhtml .= '<tbody id="payrollclassatablecontent"></tbody>';
$displayhtml .= '</table>';
$displayhtml .= '</div>';
