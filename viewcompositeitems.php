...
$displayhtml .= '<p class="oremainheader">VIEW COMPOSITE ITEMS</p>';
$displayhtml .= '</div>';
$displayhtml .= '';
$displayhtml .= '<div class="orecardcontainer">';
$displayhtml .= '<div class="vslcontainer">';
$displayhtml .= '<div style="display: flex;" class="inputcontainermsn icsn">';
$displayhtml .= '<input id="viewcompositsinput" type="text"> <img style="cursor: pointer; height: 20px; width: 20px; filter: invert(100%); position: relative; right: 25px; top: 4px" title="Search" src="../images/magnifier-4-240.png" alt="">';
$displayhtml .= '</div>';
$displayhtml .= '<div class="jtable-content">
                    <table class="jmargin-top" id="dueloans">
                        ...
                        <tbody id="viewcompositetabledata"></tbody>
                    </table>
                </div>
