<div class="jcontainer">
    <h1 class="jpageheader">PROPERTY LEDGER</h1>
    <div class="jpagecontent" id="jpagecontent">
        <div>
            <form class="jform no-pr" id ="filterpropertyledgerform" style="margin-top: 15px;">
            ...
            <div class="jtable-content" style="margin-top:10px">
                <table class="jmargin-top" id="propertyledgertable">
                    <thead>
                        <tr>
                            <th>S/N</th>
                            <th>Account&nbsp;No</th>
