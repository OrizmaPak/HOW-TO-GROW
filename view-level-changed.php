...
$displayhtml .= '<h5>VIEW LEVEL CHANGED</h5>';
$displayhtml .= '</center>';
$displayhtml .= '</div>';
...
$displayhtml .= '<th>Staff Names</th>';
$displayhtml .= '<th>Branch</th>';
$displayhtml .= '<th>Old Level</th>';
$displayhtml .= '<th>Current Level</th>';
$displayhtml .= '</tr>';
$displayhtml .= '</thead>';
$displayhtml .= '<tbody id="view-level-changed-tbody">';
$displayhtml .= '<tr>';
$displayhtml .= '<td>1</td>';
$displayhtml .= '<td>OKIKIOLA BOY</td>';
$displayhtml .= '<td>MAIN MKT</td>';
$displayhtml .= '<td>4</td>';
$displayhtml .= '<td>17</td>';
$displayhtml .= '</tr>';
$displayhtml .= '<tr>';
$displayhtml .= '<td>1</td>';
$displayhtml .= '<td>OKIKIOLA BOY</td>';
