...
$displayhtml .= '<p class="oremainheader">Termination/Resignation</p>';
$displayhtml .= '</div>';
...
$displayhtml .= '<input id="terminate_personnel" list="terminationpersonnelnames" class="" onchange="checktpersonnel(this)" placeholder="Personnel" type="text">';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="stcs1a">';
$displayhtml .= '<div class="inputcontainerln icsnf">';
$displayhtml .= '<p class="normaltext">Entry Date</p>';
$displayhtml .= '<input id="terminate_entrydate" type="date">';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="inputcontainerln icsnf">';
$displayhtml .= '<p class="normaltext">Title</p>';
$displayhtml .= '<input id="terminate_title" type="text">';
$displayhtml .= '</div>';
$displayhtml .= '<div class="stcnsection1">';
$displayhtml .= '<div class="stcs1a">';
$displayhtml .= '<div class="inputcontainerln icsnf hidden">';
$displayhtml .= '<p class="normaltext">Start Date</p>';
$displayhtml .= '<input id="terminate_startdate" type="date">';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="stcs1a">';
$displayhtml .= '<div class="inputcontainerln icsnf hidden">';
$displayhtml .= '<p class="normaltext">End Date</p>';
$displayhtml .= '<input id="terminate_enddate" type="date">'; 
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="jformgroup">';
$displayhtml .= '<div id="terminationpreview">'; 
$displayhtml .= '</div>'; 
$displayhtml .= '<div class="jformgroup jformgroupcol file-action" style="display: block;">'; 
$displayhtml .= '<input id="terminate_file" onchange="terminationloadimg(this)" type="file" accept=".png, .jpeg, .jpg, .pdf, .docx" class="jformcontrol jmargin-top hidden" >';
...
$displayhtml .= '</div>';
$displayhtml .= '<div id="terminate_fileholder" class="fileholder"> 
                </div>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="oresubmitcontainer">';
$displayhtml .= '<div id="terminate_submitbtn" class="orerbtn">Submit</div>';
$displayhtml .= '</div>';
$displayhtml .= '<div>';
$displayhtml .= '<div class="jtable-content">
                    <table class="jmargin-top" id="terminationpersonneltable">
                        <thead>
                            <tr>
                                <th>s/n </th>
                                <th> personnel </th>
                        ...
                        <tbody id="terminationpersonneltablecontent">
...
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '<datalist id="terminationpersonnelnames"></datalist>';
echo $displayhtml;
?>