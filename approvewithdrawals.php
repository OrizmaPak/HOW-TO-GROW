...
<div class="jcontainer">
    <h1 class="jpageheader"> approve withdrawals  </h1>
    <div class="jpagecontent" id="jpagecontent">
        <form class="jform no-pr" id="filterapprovewithdrawalsform">
        ...
        <div class="jtable-content" style="margin-top:50px">
            <table class="jmargin-top" id="approvewithdrawalstable">
                <thead>
                    <tr>
                        <th>s/n </th>
                        <th>T. date</th>
