...
<div class="jcontainer">
    <h1 class="jpageheader"> view Edited withdrawals  </h1>
    <div class="jpagecontent" id="jpagecontent">
        <form class="jform no-pr" id="filtervieweditedwithdrawsform">
        ...
        <div class="jtable-content" style="margin-top:50px">
            <table class="jmargin-top" id="vieweditedwithdrawstable">
                <thead>
                    <tr>
                        <th>s/n </th>
                        <th> user </th>
