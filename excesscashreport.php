<div class="jcontainer">
    <h1 class="jpageheader">EXCESS CASH REPORT</h1>
    <div class="jpagecontent" id="jpagecontent">
        <div>
            <form class="jform no-pr" id ="filterexcesscashreportform" style="margin-top: 15px;">
                <div class="col-form-group" >
                 ...
                 <div class="jflex jcontent-between no-pr" style="margin-top: 15px">
                    <span class="jcontent-between">
                        ...
                        <button type="button" class="j-action-btn no-pr jborder" style="border-color: #007bff;text-transform:capitalize;" id="print-ec">print</button>
                        <button type="button" class="j-action-btn no-pr jborder" style="background-color: transparent;border-color: rgb(2, 77, 30);color: rgb(2, 77, 30);text-transform:capitalize;" id="export-ec">export excel</button>
                    </span>
                </div>
            </form>
            
            <div class="jtable-content" style="margin-top:30px">
                <table class="jmargin-top" id="excesscashreporttable">
                    <thead>
                        <tr>
                            <th>S/N</th>
                            <th>Target</th>
