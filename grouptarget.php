...
$displayhtml .= "<h5>GROUP'S TARGET</h5>";
$displayhtml .= '</div>';
...
$displayhtml .= ' id="grouptargetlocation"';
...
$displayhtml .= ' type="text"';
$displayhtml .= ' id="grouptargetgroup"';
$displayhtml .= ' class="stockledgreceivedfrom ">';
$displayhtml .= '<option value=""></option>';
$displayhtml .= '</select>';
$displayhtml .= '</div>';
...
$displayhtml .= '<input type="number" class="stockledgdate" id="grouptargettarget"/>';
$displayhtml .= '</div>';
$displayhtml .= '</div>'; 
$displayhtml .= '<div class="split">';
$displayhtml .= '<div class="formcontrol">';
$displayhtml .= '<label for="stockledgdate">Start Period</label>';
$displayhtml .= '<input type="date" class="stockledgdate" id="grouptargetstartdate"/>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="formcontrol">';
$displayhtml .= '<label for="stockledgdate">End Period</label>';
$displayhtml .= '<input type="date" class="stockledgdate" id="grouptargetenddate"/>';
$displayhtml .= '</div>';
$displayhtml .= '</div>'; 
$displayhtml .= '';
$displayhtml .= '<div class="">';
...
$displayhtml .=  '<button type="button" class="createbranchbtn btn btnmedium btnblue mb " id="grouptargetsubmitbtn">Submit</button></div>';
$displayhtml .=  '</div>';
$displayhtml .= '';
$displayhtml .= '<div class="split">';
$displayhtml .= '<div class="formcontrol">';
...
$displayhtml .= '<div class="jtable-content">
                    <table class="jmargin-top" id="grouptargetoretable"> 
                        <thead>
                            <tr>
                                <th>s/n </th>
                                <th> branch </th>
                        ...
                        <tbody id="grouptargettablecontent">
...
$displayhtml .= '<div id="grouptargetorefulltableparant" class="jtable-content hidden">
                    <table class="jmargin-top" id="grouptargetoretable2">
                        <thead>
                            <tr>
                                <th>s/n </th>
                                <th> branch </th>
                        ...
                        <tbody id="grouptargettablecontent2">
                            
                        </tbody>
                    </table>
                </div>';
$displayhtml .= '<div style="display: flex;justify-content: flex-end;margin-top: 40px" class="">
                    <div class="orerbtn" id="grouptargetprint">Print</div>
                    <div style="background: green; width: 90px" class="orerbtn" id="grouptargetexport">Export Excel</div>
                </div>';
$displayhtml .= '';
$displayhtml .= '</div>';
