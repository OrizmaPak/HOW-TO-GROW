<div class="jcontainer">
    <div>
        <h1 class="jpageheader"> customers </h1>
    </div>
                ...
                <div class="col-form-group">
                    ...
                    <div class="jformgroup form_row">
                        ...
                        <div class="jformgroup jformgroupcol jmargin-left">
                            ...
                            <input type="text"
                                class="jformcontrol jmargin-top" id="phonenumber" name="phone" placeholder="Enter Phone Number">
                        </div>
                    </div>
            
                    <!-- Row 2 -->
                    <div class="jformgroup form_row jmargin-top">
                        <div class="jformgroup jformgroupcol">
