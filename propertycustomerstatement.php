...
<div class="jcontainer">
    <h1 class="jpageheader"> property customer statement </h1>
            ...
            <div class="col-form-group"> 
                <div class="jformgroup form_row"> 
                    ...
                    <div class="jformgroup jformgroupcol jmargin-left">
                        ...
                        <input  type="text"  class="jformcontrol jmargin-top" id="marketer" list="accountofficerlist" onchange="checkdatalist(this)" name="marketer">
                    </div> 
                </div>
                <div class="jformgroup form_row" > 
                    <div class="jformgroup jformgroupcol">
                        <label class="jcontrollabel"> location: </label>
                        <select  type="text"  class="jformcontrol jmargin-top" id="location" name="location"></select>
                    </div>
                     <div class="jformgroup jformgroupcol jmargin-left">
