...
$displayhtml .= '<p class="oremainheader">APPROVE/CONFIRM PAYROLL</p>';
$displayhtml .= '</div>';
$displayhtml .= '';
...
$displayhtml .= '<select id="confirmpayrollmonth">';
...
$displayhtml .= '<select id="confirmpayrollyear">';
...
$displayhtml .= '<div id="confirmsalary_submitbtn" class="orerbtn">Fetch</div>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
...
$displayhtml .= '';
$displayhtml .= '<div id="confirmsalarycontainer" class="jmargin-top"><div class="jflex jcontent-between no-pr jmargin-top" style="margin-bottom: 20px">
...
$displayhtml .= '<table class="jmargin-top" id="confirmsalarytable">';
$displayhtml .= '<thead>';
$displayhtml .= '<tr>';
...
$displayhtml .= '</tr>';
$displayhtml .= '</thead>';
$displayhtml .= '<tbody id="confirmpayrolltablecontent"></tbody>';
$displayhtml .= '</table>';
$displayhtml .= '</div>';
...
$displayhtml .= 'onclick="confirmpayrolltodelete()">reverse</button>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '
