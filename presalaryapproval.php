...
$displayhtml .= '<p class="oremainheader">PAYROLL</p>';
$displayhtml .= '</div>';
$displayhtml .= '';
$displayhtml .= '<div class="orecardcontainer">';
$displayhtml .= '<div class="stcnsection1">';
$displayhtml .= '<div class="" style="width: 15%">';
$displayhtml .= '<div class="inputcontainerln hidden icsn">';
$displayhtml .= '<p class="normaltext">Select Branch</p>';
$displayhtml .= '<select>';
$displayhtml .= '<option>--select branch--</option>';
$displayhtml .= '</select>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="inputcontainermsn icsn">';
$displayhtml .= '<p class="normaltext">Apply Attendance</p>';
$displayhtml .= '<select id="payrollattendance">';
$displayhtml .= '<option selected>NO</option>';
$displayhtml .= '<option>YES</option>';
$displayhtml .= '</select>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="inputcontainerln icsn">';
$displayhtml .= '<p class="normaltext">Select Month to Approval</p>';
$displayhtml .= '<select id="payrollmonth">';
...
$displayhtml .= '<select id="payrollyear">';
$displayhtml .= '<option value="">--year--</option>';
$displayhtml .= '</select>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="orecentercontainer mtt">';
$displayhtml .= '<div id="presalaryapprovebtn" class="orerbtn">Do payroll</div>';
$displayhtml .= '</div>';
$displayhtml .= '';
$displayhtml .= '</div>';
$displayhtml .= '<div class="" style="width: 85%">';
$displayhtml .= '<div style="padding: 7px" class="psaboard">';
...
$displayhtml .= '';
$displayhtml .= '<div id="presalaryapprovalcontainer" class="jmargin-top">
<div class="jflex jcontent-between no-pr jmargin-top" style="margin-bottom: 20px">
    ...
    <p style="margin: 0; display: flex; align-items: center; flex: 1;">
        TOTAL NET PAYABLES: 
        <span style="margin-left: 5px; color: green; font-weight: bold;" id="payrolltotalsalaries"></span>
    </p>
    <p style="margin: 0; display: flex; align-items: center; flex: 1;">
        TOTAL ALLOWANCE: 
        <span style="margin-left: 5px; color: green; font-weight: bold;" id="totalallowance"></span>
    </p>
    <p style="margin: 0; display: flex; align-items: center; flex: 1;">
        TOTAL DEDUCTIONS: 
...
$displayhtml .= '<table class="jmargin-top" id="presalaryapprovaltable">';
$displayhtml .= '<thead>';
$displayhtml .= '<tr>';
...
$displayhtml .= '<th> t.&nbsp;allowance </th>';
$displayhtml .= '<th> t.&nbsp;deduction </th>';
$displayhtml .= '<th> allowances </th>';
$displayhtml .= '<th> deductions </th>'; 
$displayhtml .= '<th> entry&nbsp;date </th>'; 
$displayhtml .= '</tr>';
$displayhtml .= '</thead>';
$displayhtml .= '<tbody id="approvepayrolltablecontent"></tbody>';
$displayhtml .= '</table>';
$displayhtml .= '</div>';
...
$displayhtml .= 'onclick="checkallpayrolltoapprove(this)">select all</button>&nbsp;';
$displayhtml .= '<button type="button" class="j-action-btn"';
$displayhtml .= 'style="width: 15%;text-transform: capitalize;background-color: red;"';
$displayhtml .= 'onclick="payrolltoapprove()">Delete</button>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '
