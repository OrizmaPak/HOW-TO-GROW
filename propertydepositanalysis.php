...
$displayhtml .='<h5>PROPERTY DEPOSIT ANALYSIS</h5>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="formmain" style="height: 900px">';
$displayhtml .='<div class="chart_panel">'; 
$displayhtml .='<select name="" id="threedselectmonth4">';
...
$displayhtml .='</select>';
$displayhtml .='<select name="" id="threedselectyear4">';
$displayhtml .='</select>';
$displayhtml .='<select name="" id="threedselectchart4">';
...
$displayhtml .='</select>';
$displayhtml .='</div>';
$displayhtml .='<canvas style="max-height: 600px;" id="myChartfour"></canvas>';
$displayhtml .= '</div>';
echo $displayhtml;
?>