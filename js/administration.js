...
const permset_administrationdata = [
  ...
  "COLLECTION APPROVAL SETTINGS (NET)",
...
const permset_inventorydata = [
  ...
  "GIFTS VIEW",
  "STOCK STATUS REPORT",
  "WITHDRAWAL VIEW BALANCE",
  "VIEW ARCHIVE INVENTORY LIST",
  "CONSUMABLE WITHDRAWAL TRANSACTION",
  "NON-CONSUMABLE WITHDRAWAL TRANSACTION",
  "DELETE SUPPLIER"
];
...
const permset_transactionsdata = [
  ...
  "CONFIRM BALANCE BROUGHT FORWARD",
  "COUNTER DEPOSIT INCORRECT AMOUNT PAID",
  "COUNTER POST WRONG ACCOUNT ENTRY",
