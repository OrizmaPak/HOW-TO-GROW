async function ExcessNiaDeclaration () {
    
    // alert("Vicol");
    
    await httpRequest('excess-nia-declaration.php', 'override');
        ...
        request.onreadystatechange = function(){
            ...
            if(request.readyState == 4 && request.status == 200){
                    ...
                    if(result["result"] === "ERROR"){
                        ...
                        loadExcessNiaDeclarationData(result);
    ...
    function loadExcessNiaDeclarationData(result){
	...
	function validateExcessNiaDeclaration(){
		var flag = 1;
		var mssg='';
...
// 		var papersize = document.getElementById('papersize').options[document.getElementById('papersize').selectedIndex].value;
    ...
    function displayExcessNiaDeclarationParams() {
	...
	function getExcessNiaDeclarationParams(){
		var paramstr = new FormData();
	...
	var saveExcessNiaDeclarationInfo = function(e){
		displayExcessNiaDeclarationParams();
        ...
        showSpinner();
		if(!validateExcessNiaDeclaration()){ 
		...
		request.setRequestHeader('Connection','close');
		request.send(getExcessNiaDeclarationParams());
    ...
    if(document.getElementById('btnSubmit')) document.getElementById('btnSubmit').addEventListener('click',saveExcessNiaDeclarationInfo,false);
    if(document.getElementById('btnReport')) document.getElementById('btnReport').addEventListener('click',saveExcessNiaDeclarationInfo,false);
    
    // alert();
}


var ExcessNiaDeclarationNav = document.getElementById("excess-nia-declaration");
if (ExcessNiaDeclarationNav) ExcessNiaDeclarationNav.addEventListener("click", ExcessNiaDeclaration, false);