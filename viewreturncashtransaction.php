...
$displayhtml .= '<h5>VIEW RETURN CASH TRANSACTION</h5>';
$displayhtml .= '</center>';
$displayhtml .= '</div>';
...
$displayhtml .= '<div class="vicol-display-flex-between-end-gap-1 vicol-width-90">';
...
$displayhtml .= '</div>';
$displayhtml .= '<div class="vicol-width-20">';
$displayhtml .= '<label for="company-name" class="vicol-width-90 vicol-color-red">Type Transaction Date</label><br>';
$displayhtml .= '<input class="stock-gift-input-70 vicol-width-90" type="date" name="" id="company-name" required><br>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="vicol-width-20">';
$displayhtml .= '<label for="company-name" class="vicol-width-90 vicol-color-red">Credit</label><br>';
...
$displayhtml .= '</div>';
$displayhtml .= '<div class="vicol-width-20">';
$displayhtml .= '<button class="vicol-btn-primary">&nbsp; Display &nbsp;</button>';
$displayhtml .= '</div>';
$displayhtml .= '</div><br>';
// $displayhtml .= '</div><br>';
...
$displayhtml .= '<td>3423676754</td>';
$displayhtml .= '<td>OKIKIOLA BOY</td>';
$displayhtml .= '<td>FOOD 4 LIFE</td>';
