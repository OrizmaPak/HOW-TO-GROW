<div class="jcontainer">
    <h1 class="jpageheader">PROPERTY MARKUP REPORT</h1>
    <div class="jpagecontent" id="jpagecontent">
        <div>
            <form class="jform no-pr" id ="propertymarkupreportreportform" style="margin-top: 15px;">
                <div class="col-form-group" >
                     <div class="jformgroup jformgroup form_row">
                         <div class="jformgroup jformgroupcol">
                            <label  class="jcontrollabel">Startdate</label>
                            <input type="date" name="startdate" id="matpropertymarkupreportstartdate" class="jformcontrol jmargin-top" />
                        </div>
                         <div class="jformgroup jformgroupcol jmargin-left">
                            <label  class="jcontrollabel">end date</label>
                           <input type="date" name="enddate" id="matpropertymarkupreportenddate" class="jformcontrol jmargin-top" />
                        </div>
                        <div class="jformgroup jformgroupcol  jmargin-left">
                    ...
                    <!--        <select class="jformcontrol jmargin-top" id="matpropertymarkupreportmarketer">-->
                    <!--            <option value=""> -- Select Marketer --</option>-->
                    <!--        </select>-->
                    <!--    </div>-->
                        
                    <!--    <div class="jformgroup jmargin-left" style="display:flex;align-items:end ">-->
                    <!--        <button type="button" class="j-action-btn" style="padding:10px; text-transform: capitalize;width:inherit;" id="matpropertymarkupreportviewbtn"> Generate Report </button>&nbsp;-->
                    <!--    </div>-->
                    <!--</div>-->
                </div>
            ...
            <div class="jtable-content" style="margin-top:10px">
                <table class="jmargin-top" id="propertymarkupreporttable">
                    <thead>
                         <tr>
                            <th>S/N</th>
                            <th>Date</th>
