...
$displayhtml .= '<div class="">';
$displayhtml .= '<label for="company-name" class="vicol-width-50 vicol-color-blue">Registration Point</label><br>';
$displayhtml .= '<input class="stock-gift-input-70" type="text" name="" id="registration-point" required><br>';
$displayhtml .= '</div><br>';
$displayhtml .= '<div class="">';
$displayhtml .= '<label for="company-name" class="vicol-width-50 vicol-color-blue">Branch</label><br>';
$displayhtml .= '<select class="stock-gift-input-70" type="text" name="" id="branch" required>';
$displayhtml .= '<option value="" disabled selected></option>';
$displayhtml .= '</select>';
$displayhtml .= '</div><br>';
$displayhtml .= '<div class="vicol-display-flex-between vicol-width-70">';
$displayhtml .= '<div class="vicol-width-80">';
$displayhtml .= '<button class="vicol-btn-primary" type="button" id="btnSubmit">&nbsp; Submit &nbsp;</button>';
$displayhtml .= '</div>';
$displayhtml .= '</div><br>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
