...
$displayhtml .=  '<h5>INTAKE HISTORY</h5>';
$displayhtml .=  '</div>';
...
$displayhtml .= '<div class="jtable-content">
                    <table class="jmargin-top" id="guarantorpersonneltable">
                        ...
                        <tbody id="intakehistorytablecontent">
...
$displayhtml .= '<div class="jtable-content">
                    <p>Transaction Date: <span id="intaketdmodal" style="font-weight: bold"></span> <p style="marginLeft: 20px;">Description: <span id="intakedesmodal" style="font-weight: bold"></span> </p></p>
                    <p>Location: <span id="intakelocationmodal" style="font-weight: bold"></span></p>
                    <table class="jmargin-top" id="guarantorpersonneltable">
                        <thead>
                            <tr>
                                <th>s/n </th>
                        ...
                        <tbody id="intakehistorytablecontentmodal">
