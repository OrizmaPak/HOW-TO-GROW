...
<div class="jcontainer"> 
    <h1 class="jpageheader"> EDIT DEPOSIT </h1>
    <div class="jpagecontent" id="jpagecontent">
        <form class="jform no-pr" id="filterediterrosindepositform">
            <div class="col-form-group"> 
                ...
                <div class="jformgroup form_row" >
                    <div class="jformgroup jformgroupcol">
                        ...
                        <input type="email" class="jformcontrol jmargin-top" id="email" name="email">
                    </div>
        ...
        <div class="jtable-content" style="margin-top:50px">
            <table class="jmargin-top" id="errorsindeposittable">
                <thead>
                    <tr>
                        <th>s/n </th>
                        <th> user </th>
