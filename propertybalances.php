<div class="jcontainer">
    <h1 class="jpageheader">PROPERTY CUSTOMER BALANCES</h1>
    <div class="jpagecontent" id="jpagecontent">
        <form class="jform no-pr" id="propertybalancesform" style="margin-top: 15px;">
        ...
        <p class="jcontrollabel" style="margin-top: 20px;">Submit opens property customer balances in a new tab.</p>
    </div>
</div>
