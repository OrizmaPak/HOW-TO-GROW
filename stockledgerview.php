...
$displayhtml .= '<h5>STOCK LEDGER</h5>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="formmain">';
$displayhtml .= '<form action="">';
$displayhtml .= '<div class="">';
$displayhtml .= '<div class="formcontrol">';
$displayhtml .= '<label for="stockledgitem">Select Item</label>';
$displayhtml .= '<input type="text" id="" list="stockledgitemdata" onchange="checkdatalist(this, `stockledgitem`, `stockledgitemdata1`)" class="stockledgreceivedfromw"/>';
$displayhtml .= '<input type="hidden" id="stockledgitem" class="stockledgreceivedfrom"/>';
$displayhtml .= '<datalist id="stockledgitemdata"></datalist>';
$displayhtml .= '<datalist id="stockledgitemdata1"></datalist>';
$displayhtml .= '</select>';
$displayhtml .= '</div>';
...
$displayhtml .= ' id="stockledglocation"';
...
$displayhtml .= '<input type="date" class="stockledgdate" id="stockledgstartdate"/>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="formcontrol">';
$displayhtml .= '<label for="stockledgdate">End Date</label>';
$displayhtml .= '<input type="date" class="stockledgdate" id="stockledendgdate"/>';
$displayhtml .= '</div>';
$displayhtml .= '</div>';
$displayhtml .= '';
$displayhtml .= '<div class="">';
...
$displayhtml .=  '<button type="button" class="createbranchbtn btn btnmedium btnblue mb " id="stockledgerhistoryviewbtn">View</button></div>';
$displayhtml .=  '</div>';
$displayhtml .= '';
$displayhtml .= '<div class="split">';
$displayhtml .= '<div class="formcontrol">';
...
$displayhtml .= '<div class="jtable-content">
                    <table class="jmargin-top" id="stockledgeroretable">
                        <thead>
                            <tr>
                                <th>s/n </th>
                        ...
                        <tbody id="stockledgerorehistorytablecontent">
...
$displayhtml .= '<div style="display: flex;justify-content: flex-end;margin-top: 40px" class="">
                    <div class="orerbtn" id="stockledgeroreprint">Print</div>
                    <div style="background: green; width: 90px" class="orerbtn" id="stockledgeroreexport">Export Excel</div>
                </div>';
$displayhtml .= '';
$displayhtml .= '<div id="stockledgerorefulltableparant" class="jtable-content hidden">
                    <table class="jmargin-top" id="stockledgerorefulltable2">
                        <thead>
                            <tr>
                                <th> ACCOUNT NUMBER  </th>
                                <th> first name  </th>
                        ...
                        <tbody id="stockledgeroretabledata2"></tbody>
                    </table>
                </div>';
$displayhtml .= '</div>';
