...
$displayhtml .= '<h5 class="vicol-width-100 vicol-text-align-right">ONIGBO MKT.</h5><br>';
...
$displayhtml .= '<th>Transfer No.</th>';
$displayhtml .= '<th>From Branch</th>';
$displayhtml .= '<th>To Branch</th>';
...
$displayhtml .= '<td>ONIGBO MKT.</td>';
$displayhtml .= '<td>MAIN MKT.</td>';
$displayhtml .= '<td>CASH TO HEAD BRIDGE BRANCH</td>';
$displayhtml .= '<td>UCHE</td>';
$displayhtml .= '<td>N11200.00</td>';
$displayhtml .= '<td>N230000.00</td>';
$displayhtml .= '</tr>';
$displayhtml .= '<tr>';
$displayhtml .= '<td>1</td>';
$displayhtml .= '<td>27/01/22</td>';
