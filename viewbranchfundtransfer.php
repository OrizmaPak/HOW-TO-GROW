...
$displayhtml .= '<h5> VIEW BRANCH FUND TRANSFER </h5>';
$displayhtml .= '</div>';
...
$displayhtml .= ' id="viewbranchfundtransferlocation"';
...
$displayhtml .= '<input type="date" class="stockledgdate" id="viewbranchfundtransferstartdate"/>';
$displayhtml .= '</div>';
$displayhtml .= '<div class="formcontrol">';
$displayhtml .= '<label for="stockledgdate">End Date</label>';
$displayhtml .= '<input type="date" class="stockledgdate" id="viewbranchfundtransferenddate"/>';
$displayhtml .= '</div>';
$displayhtml .= '</div>'; 
$displayhtml .= '';
$displayhtml .= '<div class="">';
...
$displayhtml .=  '<button type="button" class="createbranchbtn btn btnmedium btnblue mb " id="viewbranchfundtransferfetchview">View</button></div>';
$displayhtml .=  '</div>';
$displayhtml .= '';
$displayhtml .= '<div class="split">';
$displayhtml .= '<div class="formcontrol">';
...
$displayhtml .= '<div class="jtable-content">
                    <table class="jmargin-top" id="viewbranchfundtransferoretable">
                        <thead>
                            <tr>
                                <th>s/n </th>
                                <th> account name </th>
                                <th> account number  </th>
                                <th> account officer mail  </th>
                        ...
                        <tbody id="viewbranchfundtransferorehistorytablecontent">
...
$displayhtml .= '<div id="viewbranchfundtransferorefulltableparant" class="jtable-content hidden">
                    <table class="jmargin-top" id="viewbranchfundtransferoretable2">
                        <thead>
                            <tr>
                                <th>s/n </th>
                                <th> account name </th>
                        ...
                        <tbody id="viewbranchfundtransfer2orehistorytablecontent">
                            
                        </tbody>
                    </table>
                </div>';
$displayhtml .= '<div style="display: flex;justify-content: flex-end;margin-top: 40px" class="">
                    <div class="orerbtn" id="viewbranchfundtransferprint">Print</div>
                    <div style="background: green; width: 90px" class="orerbtn" id="viewbranchfundtransferexport">Export Excel</div>
                </div>';
$displayhtml .= '';
$displayhtml .= '</div>';
...
$displayhtml .= '</div><datalist id="viewbranchfundtransferaccounts"></datalist>';
echo $displayhtml;
?>
