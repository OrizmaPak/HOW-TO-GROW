<div class="jcontainer">
    <div>
        <h1 class="jpageheader"> MACHINE IDENTIFICATION </h1>
    </div>
    <div class="jpagecontent" id="jpagecontent">
        <form class="jform" id="filtermachineidentification">
        ...
        <div>
            <div class="jmargin-top">
                <div class="jtable-content">
                    <table class="jmargin-top" id="machineidentificationtable">
                        <thead>
                            <tr>
                                <th>s/n </th>
                                <th> Machine </th>
                        ...
                        <tbody id="machineidentificationtablejtabledata"></tbody>
                    </table>
                </div>
