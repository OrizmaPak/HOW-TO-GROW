        ...
        <div style="width:100%;display:flex;justify-content:flex-end">
          ...
          <div class="jformgroup jformgroup "> 
            ...
            <div class="jtable-content" style="margin-top:10px">
                <table class="jmargin-top" id="statementofaccounttablemodal"> 
                    <thead>
                        <tr>
                    ...
                    <tbody id="statementofaccountmodalrowbody">
...
<div class="jcontainer">
    ...
    <div class="jpagecontent" id="jpagecontent">
        <div>
            <form class="jform no-pr" id ="filterstatementofaccountform" style="margin-top: 15px;">
            ...
            <div style="margin:40px 0 20px 0;display:flex;justify-content:space-between; gap:8px;align-items:end">
                <span class="pr-hide"> 
                    <img src="../images/howlogo-removebg-preview.png" alt="How to grow logo" class="" style="width: 70px;position:relative;top:61px;margin-bottom:0px; height:auto;transform:translateY(10px)">
                </span><br/>
                ...
                <span style="display:none;gap:8px;align-items:center;text-transform:capitalize" id="accountinfo">
                    ...
                    <span style="border-radius:5px;border:1px solid lightgray;padding:7px;background-color:rgb(225, 227, 230, 0.5);font-size:10px">
                        <span>Account Name: &nbsp;<strong id="accountnamee" style="font-size:large"></strong> </span>
                    </span> 
            ...
            <div id="jtabledata1"></div>
                <table class="jmargin-top" id="statementofaccounttable">
                    <thead>
                        <tr>
                            <th>S/N</th>
