...
<div class="jcontainer">
    <h1 class="jpageheader"> Marketers Registrations & Renewals  </h1>
    <div class="jpagecontent" id="jpagecontent">
        <form class="jform no-pr" id="filtermarketerregistrationsandrenewalsform">
            ...
            <table class="jmargin-top" id="rrrtransactionreporttable">
                <thead>
                    <tr>
                        ...
                        <th> Marketer </th>
                        <th> email </th>
                        <th> total property registered </th>
                        <th> total renewals </th>
                        <th> total savings registered </th>
                    </tr>
                </thead>
                <tbody id="jtabledata"><tbody>
            </table>
        </div>
        <div class="hidden j-table-status jflex jcontent-between jmargin-top no-pr">
